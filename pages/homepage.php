    ...
    <div class="row">
        <div class="col-sm-12">
            <table class="table-bordered table pull-right" id="mytable" cellspacing="0" style="width: 100%;">
                ...
                <tr>
                    <td colspan="6">
                        <div class="content">
                            ...
                            &nbsp; &nbsp; Ex: <b><i>huzoor bux, neelam, ravi or sameer</i></b><br/>
                            <div id="result"></div>
                        </div>
                    </td>
                </tr>
                ...
                $resultLiveSearch = $liveSearch->showLiveSearch();
                if ($resultAllDetails) {
                    $i = 1;
                    foreach ($resultLiveSearch as $liveSearch) {
                        ?>
                        }
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><?php echo $liveSearch['name']; ?></td>
                            <td><?php echo $liveSearch['email']; ?></td>
                            <td><?php echo $liveSearch['date']; ?></td>
                        </tr>
                        <?php
                        $i++;
                    }
